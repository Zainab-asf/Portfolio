  ...
  return (
    <footer className="footer">
      <div className="container footer-inner">
        ...
        <a href="#hero" className="footer-logo" onClick={scrollTop}>
          <span className="logo-bracket">&lt;</span>ZA<span className="logo-bracket">/&gt;</span>
        </a>

        <p className="footer-tagline">
          Designed &amp; built by <span className="teal">Zainab Asif</span>
        </p>
        ...
        <div className="footer-links">
          ...
          <a href="mailto:zainab.asif.dev@gmail.com" aria-label="Email"><MailIcon /></a>
        </div>
